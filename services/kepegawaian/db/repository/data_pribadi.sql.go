...
select
  ...
  case
    when pegawai.jenis_jabatan_id = $2::int and pegawai.pns_id = ref_unit_kerja.pemimpin_pns_id then ref_unit_kerja.nama_jabatan
    else ref_jabatan_aktual.nama_jabatan
  end as jabatan_aktual,
  case
    when pegawai.jenis_jabatan_id = $2::int and pegawai.pns_id = ref_unit_kerja.pemimpin_pns_id then 'Struktural'
