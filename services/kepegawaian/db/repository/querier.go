...
type Querier interface {
	...
	CountPegawaiPPPK(ctx context.Context, arg CountPegawaiPPPKParams) (int64, error)
	...
	CreateRiwayatHukumanDisiplin(ctx context.Context, arg CreateRiwayatHukumanDisiplinParams) (int64, error)
	CreateRiwayatJabatan(ctx context.Context, arg CreateRiwayatJabatanParams) (int64, error)
	CreateRiwayatKenaikanGajiBerkala(ctx context.Context, arg CreateRiwayatKenaikanGajiBerkalaParams) (int64, error)
	...
	CreateRiwayatPelatihanStruktural(ctx context.Context, arg CreateRiwayatPelatihanStrukturalParams) (string, error)
	CreateRiwayatPendidikan(ctx context.Context, arg CreateRiwayatPendidikanParams) (int32, error)
	CreateRiwayatPenghargaan(ctx context.Context, arg CreateRiwayatPenghargaanParams) (int32, error)
	CreateRiwayatPenugasan(ctx context.Context, arg CreateRiwayatPenugasanParams) (int32, error)
	...
	DeleteRiwayatHukumanDisiplin(ctx context.Context, arg DeleteRiwayatHukumanDisiplinParams) (int64, error)
	DeleteRiwayatJabatan(ctx context.Context, arg DeleteRiwayatJabatanParams) (int64, error)
	DeleteRiwayatKenaikanGajiBerkala(ctx context.Context, arg DeleteRiwayatKenaikanGajiBerkalaParams) (int64, error)
	...
	DeleteRiwayatPelatihanStruktural(ctx context.Context, arg DeleteRiwayatPelatihanStrukturalParams) (int64, error)
	DeleteRiwayatPendidikan(ctx context.Context, arg DeleteRiwayatPendidikanParams) (int64, error)
	DeleteRiwayatPenghargaan(ctx context.Context, arg DeleteRiwayatPenghargaanParams) (int64, error)
	DeleteRiwayatPenugasan(ctx context.Context, arg DeleteRiwayatPenugasanParams) (int64, error)
	...
	GetRefJabatanByKode(ctx context.Context, kodeJabatan string) (GetRefJabatanByKodeRow, error)
	...
	GetRiwayatPenghargaan(ctx context.Context, arg GetRiwayatPenghargaanParams) (GetRiwayatPenghargaanRow, error)
	...
	ListLogRequestSuratKeputusan(ctx context.Context, arg ListLogRequestSuratKeputusanParams) ([]ListLogRequestSuratKeputusanRow, error)
	...
	ListPegawaiPPPK(ctx context.Context, arg ListPegawaiPPPKParams) ([]ListPegawaiPPPKRow, error)
	...
	ListRefLokasi(ctx context.Context, arg ListRefLokasiParams) ([]ListRefLokasiRow, error)
	...
	UploadBerkasRiwayatJabatan(ctx context.Context, arg UploadBerkasRiwayatJabatanParams) (int64, error)
	UploadBerkasRiwayatKenaikanGajiBerkala(ctx context.Context, arg UploadBerkasRiwayatKenaikanGajiBerkalaParams) (int64, error)
	...
	UploadBerkasRiwayatPelatihanStruktural(ctx context.Context, arg UploadBerkasRiwayatPelatihanStrukturalParams) (int64, error)
	UploadBerkasRiwayatPendidikan(ctx context.Context, arg UploadBerkasRiwayatPendidikanParams) (int64, error)
	UploadBerkasRiwayatPenugasan(ctx context.Context, arg UploadBerkasRiwayatPenugasanParams) (int64, error)
}
