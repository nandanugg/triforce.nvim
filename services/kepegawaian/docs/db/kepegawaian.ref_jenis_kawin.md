...
| ---- | ---- | ------- | -------- | -------- | ------- | ------- |
| id | integer | nextval('ref_jenis_kawin_id_seq'::regclass) | false | [kepegawaian.pegawai](kepegawaian.pegawai.md) |  |  |
...
| ---- | ---- | ---------- |
| ref_jenis_kawin_pkey | PRIMARY KEY | PRIMARY KEY (id) |

## Indexes

| Name | Definition |
| ---- | ---------- |
| ref_jenis_kawin_pkey | CREATE UNIQUE INDEX ref_jenis_kawin_pkey ON kepegawaian.ref_jenis_kawin USING btree (id) |
