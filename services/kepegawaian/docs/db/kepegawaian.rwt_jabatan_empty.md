...
| ---- | ---- | ---------- |
| rwt_jabatan_copy1_pkey | PRIMARY KEY | PRIMARY KEY ("ID") |

## Indexes

| Name | Definition |
| ---- | ---------- |
| rwt_jabatan_copy1_pkey | CREATE UNIQUE INDEX rwt_jabatan_copy1_pkey ON kepegawaian.rwt_jabatan_empty USING btree ("ID") |
