...
func Test_handler_list(t *testing.T) {
	...
	dbData := `
		...
		insert into kepegawaian.rwt_golongan
			("ID", "PNS_ID", "PNS_NIP", "PNS_NAMA", "KODE_JENIS_KP", "JENIS_KP", "ID_GOLONGAN", "GOLONGAN", "PANGKAT", "SK_NOMOR", "NOMOR_BKN", "JUMLAH_ANGKA_KREDIT_UTAMA", "JUMLAH_ANGKA_KREDIT_TAMBAHAN", "MK_GOLONGAN_TAHUN", "MK_GOLONGAN_BULAN", "SK_TANGGAL", "TANGGAL_BKN", "TMT_GOLONGAN", "STATUS_SATKER", "STATUS_BIRO", "PANGKAT_TERAKHIR", "ID_BKN", "FILE_BASE64", "KETERANGAN_BERKAS", "id_arsip", "GOLONGAN_ASAL", "BASIC", "SK_TYPE", "KANREG", "KPKN", "KETERANGAN", "LPNK", "JENIS_RIWAYAT") values
			('21', '21a',    '1c',      '21b',      '21c',           '21d',      '21e',         '21f',      '21g',     '21h',      '21i',       '21j',                       '21k',                          '21l',               '21m',               '2000-01-01', '2000-01-02',  '2000-01-03',   1,               1,             1,                  '21t',    '21u',         '21v',               1,          '1x',            '21y',   1,         '21aa',   '21ab', '21ac',       '21ad', '21ae'),
			('22', '22a',    '1c',      '22b',      '22c',           '22d',      '22e',         '22f',      '22g',     '22h',      '22i',       '22j',                       '22k',                          '22l',               '22m',               '2001-01-01', '2001-01-02',  '2002-01-03',   2,               2,             2,                  '22t',    '22u',         '22v',               2,          '2x',            '22y',   2,         '22aa',   '22ab', '22ac',       '22ad', '22ae'),
			('23', '23a',    '1c',      '23b',      '23c',           '23d',      '23e',         '23f',      '23g',     '23h',      '23i',       '23j',                       '23k',                          '23l',               '23m',               '2002-01-01', '2002-01-02',  '2001-01-03',   3,               3,             3,                  '23t',    '23u',         '23v',               3,          '3x',            '23y',   3,         '23aa',   '23ab', '23ac',       '23ad', '23ae'),
			('24', '24a',    '2c',      '24b',      '24c',           '24d',      '24e',         '24f',      '24g',     '24h',      '24i',       '24j',                       '24k',                          '24l',               '24m',               '2003-01-01', '2003-01-02',  '2003-01-03',   4,               4,             4,                  '24t',    '24u',         '24v',               4,          '4x',            '24y',   4,         '24aa',   '24ab', '24ac',       '24ad', '24ae');
				...
				"data": [
					{
						"id":                "21",
						"golongan":          "21f",
						"mk_golongan_bulan": "21m",
						"mk_golongan_tahun": "21l",
						"pangkat":           "21g",
						"tmt":               "2000-01-03"
					},
					{
						"id":                "23",
						"golongan":          "23f",
						"mk_golongan_bulan": "23m",
						"mk_golongan_tahun": "23l",
						"pangkat":           "23g",
						"tmt":               "2001-01-03"
					},
					{
						"id":                "22",
						"golongan":          "22f",
						"mk_golongan_bulan": "22m",
						"mk_golongan_tahun": "22l",
						"pangkat":           "22g",
						"tmt":               "2002-01-03"
					}
				],
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequest(http.MethodGet, "/v1/kepangkatan", nil)
