...
func Test_handler_list(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantResponseBody: `{
				"data": [
					{"id_sk": "sk-003", "kategori_sk": "Kenaikan Gaji", "no_sk": "SK-003/2024", "tanggal_sk": "2024-03-10", "status_sk": "Siap Dikoreksi", "unit_kerja": "Bawah - Tengah - Paling Atas"},
					...
					{"id_sk": "sk-001", "kategori_sk": "Kenaikan Pangkat", "no_sk": "SK-001/2024", "tanggal_sk": "2024-01-15", "status_sk": "Sudah Dikoreksi", "unit_kerja": "Bawah - Tengah - Paling Atas"}
				],
		...
		},
		{
			...
			wantResponseBody: `{
				"data": [
					{"id_sk": "sk-005", "kategori_sk": "Mutasi", "no_sk": "SK-005/2024", "tanggal_sk": "2024-03-10", "status_sk": "Siap Dikoreksi", "unit_kerja": ""}
				],
				"meta": {"limit": 10, "offset": 0, "total": 1}
			}`,
		},
		{
			...
			wantResponseBody: `{
				"data": [
					{"id_sk": "sk-006", "kategori_sk": "Mutasi", "no_sk": "SK-006/2024", "tanggal_sk": "2024-03-10", "status_sk": "Siap Dikoreksi", "unit_kerja": "Bawah 2"}
				],
				"meta": {"limit": 10, "offset": 0, "total": 1}
			}`,
		},
