...
func RegisterRoutes(e *echo.Echo, db repository, mwAuth api.AuthMiddlewareFunc) {
	...
	e.Add(http.MethodGet, "/v1/admin/pegawai/:nip/riwayat-pelatihan-fungsional", h.listAdmin, mwAuth(api.RoleAdmin))
	e.Add(http.MethodGet, "/v1/admin/pegawai/:nip/riwayat-pelatihan-fungsional/:id/berkas", h.getBerkasAdmin, mwAuth(api.RoleAdmin))
}
