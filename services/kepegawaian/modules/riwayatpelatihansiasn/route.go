...
func RegisterRoutes(e *echo.Echo, db dbRepo.Querier, mwAuth api.AuthMiddlewareFunc) {
	...
	e.Add(http.MethodPost, "/v1/admin/pegawai/:nip/riwayat-pelatihan-siasn", h.adminCreate, mwAuth(api.Kode_Pegawai_Write))
	e.Add(http.MethodPut, "/v1/admin/pegawai/:nip/riwayat-pelatihan-siasn/:id", h.adminUpdate, mwAuth(api.Kode_Pegawai_Write))
	e.Add(http.MethodDelete, "/v1/admin/pegawai/:nip/riwayat-pelatihan-siasn/:id", h.adminDelete, mwAuth(api.Kode_Pegawai_Write))
	e.Add(http.MethodPut, "/v1/admin/pegawai/:nip/riwayat-pelatihan-siasn/:id/berkas", h.adminUploadBerkas, mwAuth(api.Kode_Pegawai_Write))
}
