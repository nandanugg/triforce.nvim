...
func RegisterRoutes(e *echo.Echo, repo repository, mwAuth api.AuthMiddlewareFunc) {
	...
	e.Add(http.MethodPost, "/v1/admin/pegawai/:nip/riwayat-hukuman-disiplin", h.createAdmin, mwAuth(api.Kode_Pegawai_Write))
	e.Add(http.MethodPut, "/v1/admin/pegawai/:nip/riwayat-hukuman-disiplin/:id", h.updateAdmin, mwAuth(api.Kode_Pegawai_Write))
	e.Add(http.MethodDelete, "/v1/admin/pegawai/:nip/riwayat-hukuman-disiplin/:id", h.deleteAdmin, mwAuth(api.Kode_Pegawai_Write))
	e.Add(http.MethodPut, "/v1/admin/pegawai/:nip/riwayat-hukuman-disiplin/:id/berkas", h.adminUploadBerkas, mwAuth(api.Kode_Pegawai_Write))
}
