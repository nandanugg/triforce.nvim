...
type listResponse struct {
	Data []jenisPenghargaan `json:"data"`
...
func (h *handler) list(c echo.Context) error {
	...
	if err != nil {
		slog.ErrorContext(ctx, "Error getting list jenis penghargaan.", "error", err)
...
func (h *handler) adminGet(c echo.Context) error {
	...
	if err != nil {
		slog.ErrorContext(ctx, "Error getting jenis penghargaan.", "error", err)
		return echo.NewHTTPError(http.StatusInternalServerError)
	}
...
func (h *handler) adminCreate(c echo.Context) error {
	...
	if err != nil {
		slog.ErrorContext(ctx, "Error creating jenis penghargaan.", "error", err)
		return echo.NewHTTPError(http.StatusInternalServerError)
	}
...
func (h *handler) adminUpdate(c echo.Context) error {
	...
	if err != nil {
		slog.ErrorContext(ctx, "Error updating jenis penghargaan.", "error", err)
		return echo.NewHTTPError(http.StatusInternalServerError)
	}
...
func (h *handler) adminDelete(c echo.Context) error {
	...
	if err != nil {
		slog.ErrorContext(ctx, "Error deleting jenis penghargaan.", "error", err)
		return echo.NewHTTPError(http.StatusInternalServerError)
	}
