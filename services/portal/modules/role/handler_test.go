...
func Test_handler_list(t *testing.T) {
	...
	dbData := `
		...
		insert into "user"
			...
			('00000000-0000-0000-0000-000000000001', 'zimbra',   '1a', '1c@test.com', 'c1', null),
			('00000000-0000-0000-0000-000000000001', 'keycloak', '1a', '1a@test.com', 'a1', null),
			('00000000-0000-0000-0000-000000000002', 'zimbra',   '1b', '1b@test.com', 'b1', null),
			('00000000-0000-0000-0000-000000000003', 'zimbra',   '1c', '1c@test.com', 'c1', null),
			('00000000-0000-0000-0000-000000000004', 'zimbra',   '1d', '1d@test.com', 'd1', null),
			('00000000-0000-0000-0000-000000000005', 'zimbra',   '1e', '1e@test.com', 'e1', '2000-01-01'),
			('00000000-0000-0000-0000-000000000006', 'zimbra',   '1f', '1f@test.com', 'f1', null),
			('00000000-0000-0000-0000-000000000007', 'zimbra',   '1g', '1g@test.com', 'g1', null),
			('00000000-0000-0000-0000-000000000008', 'zimbra',   '1a', '1a@test.com', 'a1', null),
			('00000000-0000-0000-0000-000000000009', 'zimbra',   '1a', '1a@test.com', 'a1', '2000-01-01');
	`
