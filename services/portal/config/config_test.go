...
func TestLoad(t *testing.T) {
	for k, v := range map[string]string{
		...
		"NEXUS_KEYCLOAK_PUBLIC_HOST":               "http://auth-portal.local",
		"NEXUS_KEYCLOAK_REDIRECT_PATH":             "/callback",
		"NEXUS_KEYCLOAK_POST_LOGOUT_REDIRECT_PATH": "/",
	...
	assert.Equal(t, Config{
		...
		Keycloak: Keycloak{
			...
			PublicHost:             "http://auth-portal.local",
